...
namespace GADE_Task
{
    public class Map
    {
        ...
        public Map(int minWidth, int maxWidth, int minHeight, int maxHeight, int numEnemies, int numGoldDrops)
        {
            ...
            else if (("" + type).Equals("Enemy"))
            {
                ...
                do
                {
                    ...
                    if (map[posY, posX].GetSymbol == ' ')
                    {
                        ...
                        {
                            enemies[eCount] = new Mage(posX, posY, 10, 1);
                            eCount++;
                            found = true;
                        }
                    }
